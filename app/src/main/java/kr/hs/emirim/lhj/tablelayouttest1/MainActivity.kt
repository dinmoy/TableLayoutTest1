...
class MainActivity : AppCompatActivity() {
    ...
    var btnListener = OnClickListener {
        ...
        when (it.id) {
            R.id.btn_plus -> result = num1.toInt() + num2.toInt()
            R.id.btn_minus -> result = num1.toInt() - num2.toInt()
            R.id.btn_multiple -> result = num1.toInt() * num2.toInt()
            R.id.btn_divide -> result = num1.toInt() / num2.toInt()
        }
